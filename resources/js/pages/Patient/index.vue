  ...
  >
    <template v-slot:top>
      <v-toolbar
        flat
      >
        <v-toolbar-title>Patient Records</v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
...
import axios from '../../plugins/axios'
  export default {
    ...
    methods: {
      ...
      deleteItemConfirm () {
        this.patient.splice(this.editedIndex, 1)
        this.closeDelete()
      },
      ...
      save () {
        ...
        if (this.editedIndex > -1) {
            axios.post('update-patient/' + this.editedItem.id, this.editedItem).then(res => {
            console.log(res)
            ...
            axios.post('add-patient', this.editedItem).then(res => {
            console.log(res)
      ...
      display() {
        axios.get('get-patient').then(res => {
          console.log(res)
